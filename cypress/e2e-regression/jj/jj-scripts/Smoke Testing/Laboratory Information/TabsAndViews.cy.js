...
describe('05. Laboratory Information', () => {
    ...
    it('Tabs And Views', () => {
        ...
        // // Release Data - Standard View
        // GQ.Planets.LaboratoryInformation.LaboratoryRecords.ReleaseData.openStandardView()

        // // Release Data - IAL Download View
        // GQ.Planets.LaboratoryInformation.LaboratoryRecords.ReleaseData.openIALDownloadView()

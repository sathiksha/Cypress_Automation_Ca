...
describe('Bug Tracking Tests', () => {
    it('9143-BUG Expanding and double-clicking to zoom into records within Trackwise APR PQR views dont match', () => {
            // Login 
            GQ.login()
            ...
            // Expand Record
            // GQ.Planets.Product.ProductFamilies.ProductFamily.Content.QualityRecords.ChangeControls.Filtered.APQRView.expandByIndex(0)

...
describe('Sprint 4', () => {
    const GQ = new GQTest();
    it('12298-Test Case-Allows assignment of Admin Binder ownership - Optiqs Administrator', () => {
    ...
    it('12298-Test Case-Allows assignment of Admin Binder ownership - Valtest2',()=>{
        // Login 
        ...
        // // Lifecycles visible -> Not available for Business Admins
        // cy.getSC(GQ.NavBar.ElementLibrary.DataManagement.Lifecycles.locator).should('be.visible')

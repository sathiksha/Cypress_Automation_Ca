export class NonconformancesAPRPQR{
 ...
 checkMultiChoicePickerColumns() {
  ...
  checkColumns() {
  cy.fixture('qualityManagement').then(data => {
    const expectedColumnNames = data.Nonconformances.NonconformancesAPRPQR.columnNames;  // FIX ✔
...
export default new NonconformancesAPRPQR();
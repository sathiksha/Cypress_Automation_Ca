export class AssessmentExecutions {
  ...
  addBookmark() {
   ...
   minimizeARecord() {
    cy.getSC('//QMainPageBase[ID="MainPage"]/member[Class=HLayout||index=2||length=4||classIndex=0||classLength=1]/member[Class=QScreenHolder||scClass=HLayout||index=1||length=3||classIndex=0||classLength=1||scClassIndex=1||scClassLength=3]/member[Class=QScreen_Base_Loader||scClass=VLayout||index=0||length=1||classIndex=0||classLength=1||scClassIndex=0||scClassLength=1]/component/member[Class=QScreen_Item_Repository_Bootstrap||scClass=VLayout||index=0||length=1||classIndex=0||classLength=1||scClassIndex=0||scClassLength=1]/component/member[Class=QScreen_Item_Repository_Quality_Reco||scClass=VLayout||index=0||length=1||classIndex=0||classLength=1||scClassIndex=0||scClassLength=1]/body/layoutBody/member[Class=QScreen_Users||scClass=VLayout||index=0||length=2||classIndex=0||classLength=1||scClassIndex=0||scClassLength=2]/component/member[Class=QScreen_User_Quality_Records_by_User||scClass=VLayout||index=0||length=1||classIndex=0||classLength=1||scClassIndex=0||scClassLength=1]/body/layoutBody/member[Class=QScreen_Change_Controls_1||scClass=VLayout||index=0||length=7||classIndex=0||classLength=1||scClassIndex=0||scClassLength=7]/body/layoutBody/member[Class=QScreen_Assessment_Executions_1||scClass=VLayout||index=1||length=3||classIndex=0||classLength=1||scClassIndex=1||scClassLength=3]/selectorButton/openButton/icon').click();
  }
  clickAnywhereElse() {
    cy.wait(200);
  ...
  cy.fixture("qualityManagement").then(data => {
    ...
    const pickerColumns = data.QualityRecordsByUser.ChangeControls.AssessmentExecutions.multiChoicePickerColumns;  // FIX ✔
...
checkColumns() {
  cy.fixture('qualityManagement').then(data => {
    const expectedColumnNames = data.QualityRecordsByUser.ChangeControls.AssessmentExecutions.columnNames;  // FIX ✔
...
openRelatedObjects() {
   ...
   checkRelatedObjects() {
    this.loadFixture().then(data => {
      ...
      data.QualityRecordsByUser.ChangeControls.AssessmentExecutions.relatedObjects.forEach(obj => {
 ...
 checkFormsandFieldsAvailablity() {
    cy.fixture("qualityManagement").then(data => {
      const sections = data.QualityRecordsByUser.ChangeControls.AssessmentExecutions.accordionSections;
...
export default new AssessmentExecutions();

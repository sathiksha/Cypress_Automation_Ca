export class LaboratoryInvestigations {
  ...
  openRelatedObjects() {
   ...
   checkRelatedObjects() {
    this.loadFixture().then(data => {
      ...
      data.QualityRecordsByUser.NonConformances.LaboratoryInvestigations.relatedObjects.forEach(obj => {
  ...
  expandRecord() {
    ...
    minimizeARecord() {
    cy.getSC('//QMainPageBase[ID="MainPage"]/member[Class=HLayout||index=2||length=4||classIndex=0||classLength=1]/member[Class=QScreenHolder||scClass=HLayout||index=1||length=3||classIndex=0||classLength=1||scClassIndex=1||scClassLength=3]/member[Class=QScreen_Base_Loader||scClass=VLayout||index=0||length=1||classIndex=0||classLength=1||scClassIndex=0||scClassLength=1]/component/member[Class=QScreen_Item_Repository_Bootstrap||scClass=VLayout||index=0||length=1||classIndex=0||classLength=1||scClassIndex=0||scClassLength=1]/component/member[Class=QScreen_Item_Repository_Quality_Reco||scClass=VLayout||index=0||length=1||classIndex=0||classLength=1||scClassIndex=0||scClassLength=1]/body/layoutBody/member[Class=QScreen_Users||scClass=VLayout||index=0||length=2||classIndex=0||classLength=1||scClassIndex=0||scClassLength=2]/component/member[Class=QScreen_User_Quality_Records_by_User||scClass=VLayout||index=0||length=1||classIndex=0||classLength=1||scClassIndex=0||scClassLength=1]/body/layoutBody/member[Class=QScreen_Nonconformances||scClass=VLayout||index=3||length=7||classIndex=0||classLength=1||scClassIndex=3||scClassLength=7]/body/layoutBody/member[Class=QScreen_Laboratory_Investigations||scClass=VLayout||index=4||length=8||classIndex=0||classLength=1||scClassIndex=4||scClassLength=8]/selectorButton/openButton/').click();
  }
  clickAnywhereElse() {
    cy.wait(200);
  ...
  cy.fixture("qualityManagement").then(data => {
    ...
    const pickerColumns = data.QualityRecordsByUser.NonConformances.LaboratoryInvestigations.multiChoicePickerColumns;  // FIX ✔
...
checkColumns() {
  cy.fixture('qualityManagement').then(data => {
    const expectedColumnNames = data.QualityRecordsByUser.NonConformances.LaboratoryInvestigations.columnNames;  // FIX ✔
  ...
  checkFormsandFieldsAvailablity() {
    cy.fixture("qualityManagement").then(data => {
      const sections = data.QualityRecordsByUser.NonConformances.LaboratoryInvestigations.accordionSections;
...
export default new LaboratoryInvestigations();

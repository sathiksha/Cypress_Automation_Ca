...
export class LargeMolecules {
    ...
    setViewAll(){
        this.toggleView();
        cy.getSC(
            '//Menu[level=0]/body/row[itemName=All%20(LM)||0]/col[fieldName=itemName||0]'
        ).click()
    }
    toggleView(){
        cy.getSC(
    ...
    setViewAssignedToMe(){
        this.toggleView();
        cy.getSC(
            '//Menu[level=0]/body/row[itemName=Assigned%20to%20Me%20(LM)||1]/col[fieldName=itemName||0]'
        ).click()
    }
    expandRecord(num){
        cy.getSC(

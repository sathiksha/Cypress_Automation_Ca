...
describe('03. Product Development', () => {
    ...
    it('FilterRoWCatalogItemsofMarixMaterials', () => {
        const GQ = new GQTest();
        ...
        // Toggle Filter
        GQ.Planets.ProductDevelopment.MatrixMaterials.RoWCatalogItems.toggleFilter()

        // Filter column
        cy.autoTestAll(
            GQ.Planets.ProductDevelopment.MatrixMaterials.RoWCatalogItems.nameColumn(),
            []
        )

...
describe('03. Product Development', () => {
    ...
    it('FilterSPSCatalogItemsofMarixMaterials', () => {
        const GQ = new GQTest();
        ...
        // Toggle Filter
        GQ.Planets.ProductDevelopment.MatrixMaterials.SPSCatalogItems.toggleFilter()

        // Filter column
        cy.autoTestAll(
            GQ.Planets.ProductDevelopment.MatrixMaterials.SPSCatalogItems.nameColumn(),
            []
        )

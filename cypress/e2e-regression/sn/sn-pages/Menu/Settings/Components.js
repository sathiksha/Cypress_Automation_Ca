...
export class Components{
    ...
    openLandingPage(){
        cy.getSC(
            '//QMainPageBase[ID="MainPage"]/member[Class=HLayout||index=2||length=4||classIndex=0||classLength=1]/member[Class=QScreenHolder||scClass=HLayout||index=1||length=3||classIndex=0||classLength=1||scClassIndex=1||scClassLength=3]/member[Class=QScreen_Base_Loader||scClass=VLayout||index=0||length=1||classIndex=0||classLength=1||scClassIndex=0||scClassLength=1]/component/member[Class=QScreen_Config_Bootstrap||scClass=VLayout||index=0||length=1||classIndex=0||classLength=1||scClassIndex=0||scClassLength=1]/gridBar/controlTab/member[Class=ToolStripButton||index=10||length=12||classIndex=10||classLength=12||roleIndex=10||roleLength=12||title=Components||scRole=button]/'
        ).click()
    }
    createNewComponents(){
        cy.getSC(
            ...
            , { timeout: 60000 }).click()
        cy.getSC(
            '//autoID[Class=Dialog||index=20||length=21||classIndex=3||classLength=4||roleIndex=3||roleLength=4||title=Create%20Component%20Config||scRole=alertdialog]/okButton/'
            , { timeout: 60000 }).click()
    }
    delete(){
        cy.getSC(
